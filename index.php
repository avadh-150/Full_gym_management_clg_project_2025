          ...
          ?>
              <div>
                <div class="media d-block media-custom text-center">
                    ...
                    <a href="trainers/profile.php?id=<?php echo $row["id"] ?>"><img src="admin/uploads/trainers/<?php echo $row["image"] ?>" alt="Image Placeholder" class="img-fluid"></a>
                 
                    <div class="media-body">
                      <h3 class="mt-0 text-black"><?php echo $row["name"] ?></h3>
                      <p class="lead">Instructor for: <?php echo $row["specialization"] ?></p>
                    </div>
                  </div>
                </div>
