...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa--home"></i> Home</a> <a href="admins.php" class="current">Registered admins</a> </div>
...
<td><div class='text-center'><a href='edit-adminform.php?id=".$row['a_id']."'><i class='fas fa-edit'></i> Edit</a></div></td>
