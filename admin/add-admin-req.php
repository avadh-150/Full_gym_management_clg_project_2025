...
<!--sidebar-menu-->
  <?php $page='admins-entry'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->
<div id="content">
...
$qry = "INSERT INTO admin(username,email,gender,password,contact,street,city,state) values ('$username','$email','$gender','$password','$contact','$street','$city','$state')";
  ...
  echo"<div class='container-fluid'>";
      ...
      echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
          ...
          echo"<div class='widget-content'>";
              echo"<div class='error_ex'>";
              echo"<h1>Success</h1>";
              echo"<h3>Admin details has been added!</h3>";
