  ...
  <button type="submit" class="tip-bottom" title="Search"><i class="icon-search icon-white"></i></button>
    ...
    <div id="content">
        <div id="content-header">
            ...
            <h1 class="text-center">Remove Admins <i class="fas fa-group"></i></h1>
        </div>
        ...
        <td><div class='text-center'><a href='actions/delete-member.php?remove_id=" . $row['a_id'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Remove</a></div></td>
