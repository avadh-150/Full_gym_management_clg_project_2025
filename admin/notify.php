...
if (isset($_GET['id'])) {
    $query_id = $_GET['id'];
    $sql_mark_as_read = "select * from users WHERE member_id = '$query_id'";
    $res=mysqli_query($con, $sql_mark_as_read);
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>Home</a> <a href="#" class="tip-bottom">Notify</a>
...
if(isset($_REQUEST['Login'])) 
{
 ...
 try {
     ...
     $mail->isHTML(true);
     $mail->Subject = 'Due to expire your membership plan';
     $email_template = "Name: $name <br> Email: $email <br> Message: $message
          <br><a href='http://localhost/gymphp/my_membership.php'>See the more details about the your membership plans </a></br>
