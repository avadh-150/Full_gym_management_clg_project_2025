...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="#" class="current">Registered Users <i class="fas fa-group"></i> </a> </div>
                  ...
                  echo "
                      <tr>
                          ...
                          <td>
                              ...
                              <a href='edit-users.php?id={$row['id']}' class='text-success'><i class='fas fa-edit'></i></a> | 
