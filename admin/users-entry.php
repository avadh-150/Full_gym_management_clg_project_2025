                ...
                <div class="span6">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="add-users-req.php" method="POST" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="date" name="dor" class="span11" value="<?php echo date('Y-m-d'); ?>" />
                        ...
                        <div class="widget-content nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="email" id="mask-phone" name="email" placeholder="example@gmail.com" class="span8 mask text">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea class="span11" name="address" placeholder="Address" id=""></textarea>
                                    </div>
                                </div>
                            </div>
