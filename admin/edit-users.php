    ...
    ?>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="users.php" class="tip-bottom">Manamge Users</a> <a href="#" class="current">Update Users</a> </div>
                <h1 class="text-center">Modify Users Ditails</h1>
            </div>
                    ...
                    <div class="span6">
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <form action="edit-users-req.php" method="POST" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span11" name="username" value='<?php echo $row['name']; ?>' placeholder="Username" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                ...
                                <div class="form-horizontal">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="help-block blue span8">acb12re@gmail.com</span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="normal" class="control-label">Contact Number :</label>
                                        <div class="controls">
                                            <input type="number" id="mask-phone" name="contact" value='<?php echo $row['mobile']; ?>' placeholder="9876543210" class="span8 mask text">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="form-horizontal">
                                        ...
                                        <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                                            ...
                                            <button type="submit" name="submit" class="btn btn-success">Submit Users Details</button>
                                        </div>
                                        </form>
